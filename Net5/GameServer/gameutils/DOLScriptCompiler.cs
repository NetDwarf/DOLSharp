    ...
    public class DOLScriptCompiler : IScriptCompiler
    {
        ...
        public DOLScriptCompiler()
        {
            if (referencedAssemblies == null)
            {
                ...
                var additionalReferences = GameServer.Instance.Configuration.ScriptAssemblies;
        ...
        public Assembly Compile(string outputPath, IEnumerable<FileInfo> sourceFiles)
        {
            ...
            Compile(outputPath, syntaxTrees);
        ...
        public Assembly CompileFromSource(string code)
        {
            ...
            Compile(outputFile.FullName, syntaxTrees);
        ...
        private void Compile(string outputPath, IEnumerable<SyntaxTree> syntaxTrees)
        {
