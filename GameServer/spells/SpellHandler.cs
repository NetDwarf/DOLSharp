...
namespace DOL.GS.Spells
{
	...
	public class SpellHandler : ISpellHandler
	{
		...
		public virtual bool CheckBeginCast(GameLiving selectedTarget, bool quiet)
		{
			...
			var spellTargetType = SpellTargetType.Create(Spell.Target);
			if(spellTargetType.CheckBeginCast(this, Caster, selectedTarget, quiet) == false)
            {
				return false;
            }
			selectedTarget = spellTargetType.SelectSpellTarget(Caster, selectedTarget);
