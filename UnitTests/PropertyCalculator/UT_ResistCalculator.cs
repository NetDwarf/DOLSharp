...
namespace DOL.UnitTests.GameServer.PropertyCalc
{
	...
	class UT_ResistCalculator
	{
		...
		[Test]
		public void CalcValue_L50NPCWith50ItemResistAnd5ItemResistOvercap_31()
		{
			var resistCalc = createResistCalculator();
			var npc = Create.FakeNPC();
			npc.Level = 50;
			npc.Boni.Add(Bonus.Item.Create(50, eProperty.Resist_Body));
			npc.Boni.Add(Bonus.Item.Create(5, eProperty.BodyResCapBonus));
		...
		[Test]
		public void CalcValue_L50NPCWith50ItemResistAnd6ItemResistOvercap_31()
		{
			var resistCalc = createResistCalculator();
			var npc = Create.FakeNPC();
			npc.Level = 50;
			npc.Boni.Add(Bonus.Item.Create(50, eProperty.Resist_Body));
			npc.Boni.Add(Bonus.Item.Create(6, eProperty.BodyResCapBonus));
		...
		public void CalcValue_15BaseBuffAnd15ExtraBuffResist_24()
		{
			var resistCalc = createResistCalculator();
			var npc = Create.FakeNPC();
			npc.Boni.Add(Bonus.ExtraBuff.Create(15, eProperty.Resist_Body));
			npc.Boni.Add(Bonus.BaseBuff.Create(15, eProperty.Resist_Body));
